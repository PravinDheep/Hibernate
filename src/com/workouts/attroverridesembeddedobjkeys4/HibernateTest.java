...
public class HibernateTest {
	...
	public static void main(String[] args) {
		...
		/* From 5.3 */
		ServiceRegistry sreg = new StandardServiceRegistryBuilder().configure("com/workouts/attroverridesembeddedobjkeys4/hibernate.cfg.xml").build();
